...
class SettingController extends Controller
{
    ...
    public function save(Request $request)
    {
        ...
        if ($setting != "") {
            ...
            $setting->why_join            = $request['why_join'];
            $setting->feature_limit          = $request['feature_limit'];
            $setting->category_limit            = $request['category_limit'];
            $setting->doctor_limit            = $request['doctor_limit'];
            $setting->hospital_limit            = $request['hospital_limit'];
            $setting->project_completed            = $request['project_completed'];
            $setting->patients_satisfied            = $request['patients_satisfied'];
            $setting->medical_beds            = $request['medical_beds'];
            $setting->laboratory_experts            = $request['laboratory_experts'];
            $setting->meta_title            = $request['meta_title'];
            $setting->meta_description            = $request['meta_description'];
            $setting->meta_keyword            = $request['meta_keyword'];
            $setting->header_script_markup            = $request['header_script_markup'];
            $setting->footer_script_markup            = $request['footer_script_markup'];
