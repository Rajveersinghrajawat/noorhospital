                                ...
                                <div class="dynamic_field">
                                    ...
                                    <div class="row rowdelete">
                                        ...
                                        <div class="col-11 col-md-11 col-lg-11">
                                            <div class="form-group">
                                                ...
                                                <?php } ?>
                                                <input type="text" name="package[{{$imgkey}}][title]" value="{{ isset($img_data->question) ? $img_data->question : '' }}" placeholder="Question" class="form-control" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-12">
                                            ...
                                            <textarea name="package[{{$imgkey}}][description]" class="form-control" placeholder="Enter Answer" >{{ isset($img_data->answer) ? $img_data->answer : '' }}</textarea>
                                        </div>
                                    </div>
                                    <br>
                                    @endforeach
                                    ...
                                    <div class="row rowdelete">
                                        ...
                                        <div class="col-11 col-md-11 col-lg-11">
                                            <div class="form-group">
                                                <label>Question </label>
                                                <input type="text" name="package[0][title]" value="{{ isset($varimage->image_order) ? $varimage->image_order : '' }}" class="form-control" placeholder="Question" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-12">
                                            <label class="form-label">Answer </label>
                                            <textarea name="package[0][description]" class="form-control" placeholder="Enter Answer" ></textarea>
                                        </div>
