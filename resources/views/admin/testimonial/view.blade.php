                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-sm-flex align-items-center justify-content-between">
                                        ...
                                        <div class="page-title-right add_button">
                                            <a href="{{route('testimonial_add')}}"> <button type="button" class="btn btn-success waves-effect waves-light">Add</button></a>
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            var table = $('.table_data').DataTable({
                ...
                ajax: {
                    url: "{{ url('/admin/testimonial-data') }}",
                    data: function(d) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res == "Success") {
                        swal({
                                title: "Change Status!",
                                text: "Testimonial Status Change Sussessfully",
                                icon: "success",
                                dangerMode: true,
                                buttons: false,
                                timer: 1000
