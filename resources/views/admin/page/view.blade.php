                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-12">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        ...
                                        <div class="page-title-right add_button">
                                            <a href="{{route('page_add')}}"> <button type="button" class="btn btn-success waves-effect waves-light">Add</button></a>
                                        </div>
                            ...
                            <table  class="table table-bordered  nowrap table_data">
                                <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Title</th>
        ...
        $.ajax(
        {
            ...
            success: function (res)
            {
                if (res == "Success")
                {
                    swal({
                    title: "Change Status!",
                    text: "Collection Status Change Sussessfully",
                    icon: "success",
                    dangerMode: true,
                    buttons: false,
                    timer: 1000
