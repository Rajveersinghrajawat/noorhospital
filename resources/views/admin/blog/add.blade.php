                        ...
                        <div class="card-body">
                            <form method="post" id="form-data" action="{{$saveurl}}" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="short_description" class="form-control" placeholder="Enter Short short description">{{ old('short_description',isset($getdata->short_description) ? $getdata->short_description : '' )}}</textarea>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Description</label>
                                    <textarea name="editor1" class="form-control " placeholder="Enter Short Description">{{ old('editor1',isset($getdata->description) ? $getdata->description : '' )}}</textarea>
                                </div>
    ...
    <script>
        $("#form-data").validate({
            ...
            messages: {
                ...
                'editor1': "Please Select description.",
            },
