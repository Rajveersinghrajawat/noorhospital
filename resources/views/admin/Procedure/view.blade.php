...
<div class="main-content">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-sm-flex align-items-center justify-content-between">
                                        ...
                                        <div class="page-title-right add_button">
                                            <a href="{{route('procedure_add')}}"> <button type="button" class="btn btn-success waves-effect waves-light">Add</button></a>
                                        </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on("click", ".delete-button", function(e) {
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            url: "{{ url('admin/procedure/delete') }}",
                            datatType: 'json',
                            type: 'GET',
                            data: {
                                'id': id,
    ...
    <script type="text/javascript">
        function changeStatus(id, status) {
            ...
            $.ajax({
                url: "{{ url('admin/procedure/status') }}",
                type: 'GET',
                data: {
                    'id': id,
                    'status': status,
                ...
                success: function(res) {
                    if (res == "Success") {
                        swal({
                                title: "Change Status!",
                                text: "Procedure Status Change Sussessfully",
                                icon: "success",
                                dangerMode: true,
                                buttons: false,
                                timer: 1000
