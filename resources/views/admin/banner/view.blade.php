                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-sm-flex align-items-center justify-content-between">
                                        ...
                                        <div class="page-title-right add_button">
                                            <a href="{{route('banner_add')}}"> <button type="button" class="btn btn-success waves-effect waves-light">Add</button></a>
                                        </div>

                                    </div>
                                </div>
                            </div>
                            <table class="table table-bordered w-100 table_data">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th data-orderable="false">Image</th>
                                         <th data-orderable="false">Mobile Image</th>
                                        <th>Title</th>
                                        <th>Description</th>
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res == "Success") {
                        swal({
                                title: "Change Status!",
                                text: "Banner Status Change Sussessfully",
                                icon: "success",
                                dangerMode: true,
                                buttons: false,
                                timer: 1000
