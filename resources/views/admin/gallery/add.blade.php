                        ...
                        <div class="card-body">
                            <form method="post" id="form-data" action="{{$saveurl}}" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" value="{{ old('title',isset($getdata->title) ? $getdata->title : '' )}}" class="form-control" placeholder="Enter title" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="select_type" name="type" onchange="select_data()">
                                ...
                                <div class="row hide_image">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if(empty($getdata->id))
                                            <input type="file" id="input-file-now" accept="image/*" name="image" class="dropify"  required />
                                            @else
                                ...
                                <div class="mb-3 hide_vide">
                                    <label class="form-label">Video Url <span class="text-danger">*</span></label>
                                    <input type="text" name="video_url" value="{{ old('video_url',isset($getdata->video_url) ? $getdata->video_url : '' )}}" class="form-control" placeholder="Enter video url" required>
                                </div>
