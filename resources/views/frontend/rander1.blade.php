...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet"
    ...
    <link rel="stylesheet" href="{{url('/public/landing/')}}/css/owl.carousel.min.css">
    <link rel="stylesheet" href="{{url('/public/landing/')}}/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="{{url('/public/landing/')}}/css/custom.css" />
    ...
    <div class="form-holder">
        <i class="fas fa-times" id="form-close" onclick="formClose()"></i>
        <form action="">
            <div>
        ...
        <header class="container-fluid px-lg-5">
            ...
            <div class="row">
                <div class="col-lg-8 p-4">
                    <div class="logo">
                        <img src="{{url('/public/landing/')}}/images/logo2.svg" alt="" width="200" />
                    </div>
                ...
                <div class="col-lg-8">
                    <h2>
                        Noor Medicare – Your Reliable Medical Assistant in India <img class="ind-img"
                            src="{{url('/public/landing/')}}/images/img.png" alt="">
                    </h2>
                    <p>
                        ...
                        <div class="loop owl-carousel owl-theme custom-slider">
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/doctor/Dr T.S Kler.png" alt="">
                                </div>
                                <h5>Dr. T.S Kler</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/doctor/dr-dr-ramkinkar-jha (1).jpg" alt="">
                                </div>
                                <h5>Dr. Ramkinkar Jha</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/doctor/dr-i-p-s-oberoi.jpg" alt="">
                                </div>
                                <h5>Dr. I P S Oberoi</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/doctor/Dr-Vivek-Vij.jpg" alt="">
                                </div>
                                <h5>Dr. Vivek Vij</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/doctor/Dr_Anant_Kumar.jpg" alt="">
                                </div>
                                <h5>Dr. Anant Kumar</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/doctor/drhiteshgarg.jpg" alt="">
                                </div>
                                <h5>Dr. Hitesh Garg</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/doctor/Naresh_Trehan.jpg" alt="">
                                </div>
                                <h5>Dr. Naresh Trehan</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/doctor/sandeep vaishya.jpg" alt="">
                                </div>
                                <h5>Dr. Sandeep Vaishya</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/doctor/vikas dua.jpg" alt="">
                                </div>
                                <h5>Dr. Vikas Dua</h5>
                            </div>
                        </div>
                ...
                <div class="col-lg-8">
                    <div class="row">
                        <div class="loop owl-carousel owl-theme custom-slider">
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/hospitals/apollo hospitals.jpg" alt="">
                                </div>
                                <h5>Apollo Hospitals</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/hospitals/Artemis Hospial.jpg" alt="">
                                </div>
                                <h5>Artemis Hospial</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/hospitals/Blk max.jpg" alt="">
                                </div>
                                <h5>Blk max</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/hospitals/Fortis Hospital.jpg" alt="">
                                </div>
                                <h5>Fortis Hospital</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/hospitals/Jaypee Hospital.jpg" alt="">
                                </div>
                                <h5>Jaypee Hospital</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/hospitals/Manipal hospital.jpeg" alt="">
                                </div>
                                <h5>Manipal hospital</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/hospitals/Max Blk Saket.jpg" alt="">
                                </div>
                                <h5>Max Blk Saket</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/hospitals/Medanta.jpg" alt="">
                                </div>
                                <h5>Medanta</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="{{url('/public/landing/')}}/images/hospitals/Venkateshwar Hospital.jpg" alt="">
                                </div>
                ...
                <div class="col-lg-8">
                    <div class="row">
                        <div class="loop owl-carousel owl-theme custom-slider">
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="images/hospitals/apollo hospitals.jpg" alt="">
                                </div>
                                <h5>Apollo Hospitals</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="images/hospitals/Artemis Hospial.jpg" alt="">
                                </div>
                                <h5>Artemis Hospial</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="images/hospitals/Blk max.jpg" alt="">
                                </div>
                                <h5>Blk max</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="images/hospitals/Fortis Hospital.jpg" alt="">
                                </div>
                                <h5>Fortis Hospital</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="images/hospitals/Jaypee Hospital.jpg" alt="">
                                </div>
                                <h5>Jaypee Hospital</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="images/hospitals/Manipal hospital.jpeg" alt="">
                                </div>
                                <h5>Manipal hospital</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="images/hospitals/Max Blk Saket.jpg" alt="">
                                </div>
                                <h5>Max Blk Saket</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="images/hospitals/Medanta.jpg" alt="">
                                </div>
                                <h5>Medanta</h5>
                            </div>
                            <div class="item">
                                <div class="slider-img-box">
                                    <img src="images/hospitals/Venkateshwar Hospital.jpg" alt="">
                                </div>
                                <h5>Venkateshwar Hospital</h5>
                            </div>
                        </div>
